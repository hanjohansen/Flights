...
{
    Task<TournamentState> CreateTournament(Guid tenantId, List<Guid> players, int firstRoundPlayersPerGame, GameType type, bool semiFinalWithLosersCup, int x01Target, InOutModifier inMod,
